This AI-powered full-stack system combines real-time Computer Vision with a cloud-connected web dashboard to automate occupancy tracking. Using YOLOv8 and OpenCV, it counts people entering and exiting a space, announces changes via voice alerts (pyttsx3), and visualizes the live and historical data on a responsive React.js interface. Built with privacy in mind (no facial recognition), it addresses key operational challenges like safety compliance, space optimization, and analytics.
